...
public class ImageIntegrationTests {
    ...
    public void cargarDatos() throws FindByIdException, BadRequestException {
        ...
        ProductDTO productDTO = productServiceImpl.save(new ProductDTO(1,"Hotel Plaza","Hotel 5 estrellas",123.45,143.67,"Calle Falsa 123, CABA",9,"En el centro",categoryDTO,cityDTO,"rules","health","politics"));
