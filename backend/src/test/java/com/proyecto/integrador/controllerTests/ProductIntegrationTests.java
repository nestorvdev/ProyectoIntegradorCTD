...
public class ProductIntegrationTests {
    ...
    public void cargarDatos() throws FindByIdException, BadRequestException {
        ...
        productController.create(new ProductDTO("Hotel Plaza","Hotel 5 estrellas",236.45,256.67,"Calle Falsa 123, CABA",9,"En el centro",categoryDTO,cityDTO,"rules","health","politics"));
        productController.create(new ProductDTO("Hotel New World","Hotel 3 estrellas",543.45,143.67,"Calle Falsa 123, CABA",7,"Lejos del centro",categoryDTO,cityDTO,"rules","health","politics"));
    }
    ...
    public void crearProducto() throws Exception {
        CategoryDTO categoryDTO = categoryServiceImpl.save(new CategoryDTO(1,"Apart Hotels", "500.012", "http://exampleproduct.com"));
        CityDTO cityDTO = cityServiceImpl.save(new CityDTO (1,"Merlo","Argentina"));
        ProductDTO payloadDTO = new ProductDTO("Hotel Plaza","Hotel 5 estrellas",236.45,256.67,"Calle Falsa 123, CABA",9,"En el centro",categoryDTO,cityDTO,"rules","health","politics");
        ProductDTO responseDTO = new ProductDTO(1,"Hotel Plaza","Hotel 5 estrellas",236.45,256.67,"Calle Falsa 123, CABA",9,"En el centro",categoryDTO,cityDTO,"rules","health","politics");
