...
public class ProductIntegrationTests {
    ...
    public void cargarDatos() throws FindByIdException {
        ...
        productController.create(new ProductDTO("Hotel Plaza","Hotel 5 estrellas",236.45,256.67,9,false,"En el centro",categoryDTO,cityDTO));
        productController.create(new ProductDTO("Hotel New World","Hotel 3 estrellas",543.45,143.67,7,false,"Lejos del centro",categoryDTO,cityDTO));
    }
    ...
    public void crearProducto() throws Exception {
        CategoryDTO categoryDTO = categoryServiceImpl.save(new CategoryDTO(1,"Apart Hotels", "500.012", "http://exampleproduct.com"));
        CityDTO cityDTO = cityServiceImpl.save(new CityDTO (1,"Merlo","Argentina"));
        ProductDTO payloadDTO = new ProductDTO("Hotel Plaza","Hotel 5 estrellas",236.45,256.67,9,false,"En el centro",categoryDTO,cityDTO);
        ProductDTO responseDTO = new ProductDTO(1,"Hotel Plaza","Hotel 5 estrellas",236.45,256.67,9,false,"En el centro",categoryDTO,cityDTO);
