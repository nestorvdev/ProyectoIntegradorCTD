...
public class ProductServiceUnitTest {
    ...
    public void reset() throws Exception{
        ...
        product = new ProductDTO (3,"Hotel Plaza","Hotel 5 estrellas",123.45,143.67,"Calle Falsa 123, CABA",9,"En el centro",new CategoryDTO(1),new CityDTO(1),"rules","health","politics");
        configureMockito();
    }
